  ...
  return (
    <div className="bg-black bg-opacity-90 mt-[5%]">
      <div className="px-[5%] py-[5%] space-y-4">
        <div className="text-3xl font-extrabold text-white text-center md:text-left">
          <span>
        ...
        <div className="flex flex-row space-x-1 justify-center md:justify-start">
          ...
          ></input>
          <button className="bg-white text-black text-sm font-bold px-1 md:px-4 rounded-[4px]">
            Subscribe
          </button>
        </div>
      </div>

      <div className="bg-black tt-[5%] text-white">
        <div className="py-[5%] px-[5%] flex-1 md:flex justify-around space-y-4">
